...
export default function HeaderMainSidebar() {
  ...
  return (
    <div
      className="w-[100%] h-[8em] p-2  flex justify-around flex-col overflow-hidden
                items-center "
    >
      <button
        className={`w-[90%] h-[2.5em] text-[#fff] bg-[#151515] flex justify-center items-center 
      ...
      >
        ...
        <span
          className={`w-[8em] ${bebasNeue.className} ${isOpen ? "initial" : "hidden"}`}
        >
          Home
        </span>
      </button>
      ...
      <span
        className={`w-[95%] h-[3em] flex justify-center cursor-pointer
      ...
      >
        <button
          className={`rounded-[10px] w-[2.8em] h-[90%] flex justify-center items-center
